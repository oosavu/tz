...
//copypaste from https://www.codeproject.com/Tips/5261900/Cplusplus-Lightweight-Parsing-Command-Line-Argumen
template <class Opts>
struct CmdOpts : Opts
{
    using MyProp = std::variant<std::string Opts::*, int Opts::*, double Opts::*, bool Opts::*, uint64_t Opts::*>;
